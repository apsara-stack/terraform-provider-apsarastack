...
func dataSourceApsaraStackInstanceTypes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackInstanceTypesRead,
...
func dataSourceApsaraStackInstanceTypesRead(d *schema.ResourceData, meta interface{}) error {
