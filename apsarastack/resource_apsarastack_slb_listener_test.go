...
func TestAccApsaraStackSlbListener_http_basic(t *testing.T) {
...
func TestAccApsaraStackSlbListener_tcp_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_slb_listener.default"
	ra := resourceAttrInit(resourceId, nil)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
...
func TestAccApsaraStackSlbListener_tcp_server_group(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_slb_listener.default"
	ra := resourceAttrInit(resourceId, nil)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
...
func TestAccApsaraStackSlbListener_udp_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_slb_listener.default"
	ra := resourceAttrInit(resourceId, nil)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
...
func TestAccApsaraStackSlbListener_http_healcheckmethod(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_slb_listener.default"
	ra := resourceAttrInit(resourceId, nil)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
...
func testAccCheckSlbListenerDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "apsarastack_slb_listener" {
			continue
		}
		protocol := ""
		port := 0
