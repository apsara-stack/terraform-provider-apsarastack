...
func init() {
	resource.AddTestSweepers("apsarastack_logtail_config", &resource.Sweeper{
		Name: "apsarastack_logtail_config",
...
func TestAccApsaraStackLogTail_basic(t *testing.T) {
	var v *sls.LogConfig
	resourceId := "apsarastack_logtail_config.default"
...
func TestAccApsaraStackLogTail_plugin(t *testing.T) {
	var v *sls.LogConfig
	resourceId := "apsarastack_logtail_config.default"
	ra := resourceAttrInit(resourceId, logTailMap)
	serviceFunc := func() interface{} {
...
func TestAccApsaraStackLogTail_multi(t *testing.T) {
	var v *sls.LogConfig
	resourceId := "apsarastack_logtail_config.default.4"
	ra := resourceAttrInit(resourceId, logTailMap)
	serviceFunc := func() interface{} {
		return &LogService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
