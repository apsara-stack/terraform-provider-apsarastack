...
func dataSourceApsaraStackMongoDBZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackMongoDBZonesRead,
...
func dataSourceApsaraStackMongoDBZonesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_mongodb_zones", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
