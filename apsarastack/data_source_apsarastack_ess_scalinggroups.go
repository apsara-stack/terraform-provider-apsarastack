...
func dataSourceApsaraStackEssScalingGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEssScalingGroupsRead,
...
func dataSourceApsaraStackEssScalingGroupsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ess_scalinggroups", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
