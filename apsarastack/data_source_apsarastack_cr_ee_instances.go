...
func dataSourceApsaraStackCrEEInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackCrEEInstancesRead,
...
func dataSourceApsaraStackCrEEInstancesRead(d *schema.ResourceData, meta interface{}) error {
