...
func dataSourceApsaraStackSlbServerGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSlbServerGroupsRead,
...
func dataSourceApsaraStackSlbServerGroupsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_slb_server_groups", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
