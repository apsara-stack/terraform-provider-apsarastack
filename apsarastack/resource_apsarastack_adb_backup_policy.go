...
func resourceApsaraStackAdbBackupPolicy() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackAdbBackupPolicyCreate,
		Read:   resourceApsaraStackAdbBackupPolicyRead,
		Update: resourceApsaraStackAdbBackupPolicyUpdate,
		Delete: resourceApsaraStackAdbBackupPolicyDelete,
...
func resourceApsaraStackAdbBackupPolicyCreate(d *schema.ResourceData, meta interface{}) error {

	d.SetId(d.Get("db_cluster_id").(string))

	return resourceApsaraStackAdbBackupPolicyUpdate(d, meta)
}

func resourceApsaraStackAdbBackupPolicyRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackAdbBackupPolicyUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceApsaraStackAdbBackupPolicyRead(d, meta)
}

func resourceApsaraStackAdbBackupPolicyDelete(d *schema.ResourceData, meta interface{}) error {
