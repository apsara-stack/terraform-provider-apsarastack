...
func resourceApsaraStackEdasK8sApplication() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackEdasK8sApplicationCreate,
		Read:   resourceApsaraStackEdasK8sApplicationRead,
		Update: resourceApsaraStackEdasK8sApplicationUpdate,
		Delete: resourceApsaraStackEdasK8sApplicationDelete,
...
func resourceApsaraStackEdasK8sApplicationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_edas_k8s_application", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackEdasK8sApplicationRead(d, meta)
}

func resourceApsaraStackEdasK8sApplicationRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	edasService := EdasService{client}
	...
	if err != nil {
		if NotFoundError(err) {
			log.Printf("[DEBUG] Resource apsarastack_edas_k8s_application ecsService.DescribeEdasK8sApplication Failed!!! %s", err)
			d.SetId("")
			return nil
		}
		return WrapError(err)
...
func resourceApsaraStackEdasK8sApplicationUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	edasService := EdasService{client}
...
func resourceApsaraStackEdasK8sApplicationDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	edasService := EdasService{client}
