...
func dataSourceApsaraStackInstanceTypeFamilies() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackInstanceTypeFamiliesRead,
...
func dataSourceApsaraStackInstanceTypeFamiliesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_instance_type_families", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
