...
func dataSourceApsaraStackMongoDBInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackMongoDBInstancesRead,
...
func dataSourceApsaraStackMongoDBInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_mongodb_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
