...
func (s *LogService) DescribeLogStore(id string) (*sls.LogStore, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "LogStoreNotExist"}) {
			return store, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return store, WrapErrorf(err, DefaultErrorMsg, id, "GetLogStore", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogStoreIndex(id string) (*sls.Index, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "LogStoreNotExist", "IndexConfigNotExist"}) {
			return index, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return index, WrapErrorf(err, DefaultErrorMsg, id, "GetIndex", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogMachineGroup(id string) (*sls.MachineGroup, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "GroupNotExist", "MachineGroupNotExist"}) {
			return group, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return group, WrapErrorf(err, DefaultErrorMsg, id, "GetMachineGroup", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogtailConfig(id string) (*sls.LogConfig, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "LogStoreNotExist", "ConfigNotExist"}) {
			return response, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return response, WrapErrorf(err, DefaultErrorMsg, id, "GetConfig", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogtailAttachment(id string) (groupName string, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "ConfigNotExist", "MachineGroupNotExist"}) {
			return groupName, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return groupName, WrapErrorf(err, DefaultErrorMsg, id, "GetAppliedMachineGroups", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogAlert(id string) (*sls.Alert, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "JobNotExist"}) {
			return alert, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return alert, WrapErrorf(err, DefaultErrorMsg, id, "GetLogstoreAlert", ApsaraStackLogGoSdkERROR)
	}
...
func (s *LogService) DescribeLogDashboard(id string) (*sls.Dashboard, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ProjectNotExist", "DashboardNotExist"}) {
			return dashboard, WrapErrorf(err, NotFoundMsg, ApsaraStackLogGoSdkERROR)
		}
		return dashboard, WrapErrorf(err, DefaultErrorMsg, id, "GetLogstoreDashboard", ApsaraStackLogGoSdkERROR)
	}
