...
func resourceApsaraStackSlbMasterSlaveServerGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackSlbMasterSlaveServerGroupCreate,
		Read:   resourceApsaraStackSlbMasterSlaveServerGroupRead,
		Update: resourceApsaraStackSlbMasterSlaveServerGroupUpdate,
		Delete: resourceApsaraStackSlbMasterSlaveServerGroupDelete,
...
func resourceApsaraStackSlbMasterSlaveServerGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_slb_master_slave_server_group", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
	response, _ := raw.(*slb.CreateMasterSlaveServerGroupResponse)
	d.SetId(response.MasterSlaveServerGroupId)

	return resourceApsaraStackSlbMasterSlaveServerGroupRead(d, meta)
}

func resourceApsaraStackSlbMasterSlaveServerGroupRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackSlbMasterSlaveServerGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	return nil
}

func resourceApsaraStackSlbMasterSlaveServerGroupDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	slbService := SlbService{client}
