...
func resourceApsaraStackLaunchTemplate() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackLaunchTemplateCreate,
		Read:   resourceApsaraStackLaunchTemplateRead,
		Update: resourceApsaraStackLaunchTemplateUpdate,
		Delete: resourceApsaraStackLaunchTemplateDelete,
...
func resourceApsaraStackLaunchTemplateCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_launch_template", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	return resourceApsaraStackLaunchTemplateRead(d, meta)
}

func resourceApsaraStackLaunchTemplateRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackLaunchTemplateUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackLaunchTemplateDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
