...
func dataSourceApsaraStackSlbDomainExtensions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSlbDomainExtensionsRead,
...
func dataSourceApsaraStackSlbDomainExtensionsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_slb_domain_extensions", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
