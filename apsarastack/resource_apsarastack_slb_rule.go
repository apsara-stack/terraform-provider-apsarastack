...
func resourceApsaraStackSlbRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackSlbRuleCreate,
		Read:   resourceApsaraStackSlbRuleRead,
		Update: resourceApsaraStackSlbRuleUpdate,
		Delete: resourceApsaraStackSlbRuleDelete,
...
func resourceApsaraStackSlbRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err = resource.Retry(3*time.Minute, func() *resource.RetryError {
		...
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_slb_rule", request.GetActionName(), ApsaraStackSdkGoERROR)
	}

	response, _ := raw.(*slb.CreateRulesResponse)
	d.SetId(response.Rules.Rule[0].RuleId)

	return resourceApsaraStackSlbRuleUpdate(d, meta)
}

func resourceApsaraStackSlbRuleRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackSlbRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceApsaraStackSlbRuleRead(d, meta)
}

func resourceApsaraStackSlbRuleDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	slbService := SlbService{client}
