...
func resourceApsaraStackNetworkAclAttachment() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackNetworkAclAttachmentCreate,
		Read:   resourceApsaraStackNetworkAclAttachmentRead,
		Update: resourceApsaraStackNetworkAclAttachmentUpdate,
		Delete: resourceApsaraStackNetworkAclAttachmentDelete,
...
func resourceApsaraStackNetworkAclAttachmentCreate(d *schema.ResourceData, meta interface{}) error {

	d.SetId(d.Get("network_acl_id").(string) + COLON_SEPARATED + resource.UniqueId())

	return resourceApsaraStackNetworkAclAttachmentUpdate(d, meta)
}

func resourceApsaraStackNetworkAclAttachmentRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackNetworkAclAttachmentUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
...
func resourceApsaraStackNetworkAclAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
