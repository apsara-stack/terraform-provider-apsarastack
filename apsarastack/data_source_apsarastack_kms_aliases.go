...
func dataSourceApsaraStackKmsAliases() *schema.Resource {
...
func dataSourceApsarStackKmsAliasesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_kms_aliases", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
