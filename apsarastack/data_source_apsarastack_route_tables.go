...
func dataSourceApsaraStackRouteTables() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackRouteTablesRead,
...
func dataSourceApsaraStackRouteTablesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err := invoker.Run(func() error {
			...
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_route_tables", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
