...
func resourceApsaraStackDBReadWriteSplittingConnection() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackDBReadWriteSplittingConnectionCreate,
		Read:   resourceApsaraStackDBReadWriteSplittingConnectionRead,
		Update: resourceApsaraStackDBReadWriteSplittingConnectionUpdate,
		Delete: resourceApsaraStackDBReadWriteSplittingConnectionDelete,
...
func resourceApsaraStackDBReadWriteSplittingConnectionCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceApsaraStackDBReadWriteSplittingConnectionUpdate(d, meta)
}

func resourceApsaraStackDBReadWriteSplittingConnectionRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackDBReadWriteSplittingConnectionUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	rdsService := RdsService{client}
	...
	if !update && d.IsNewResource() {
		return resourceApsaraStackDBReadWriteSplittingConnectionRead(d, meta)
	}
...
func resourceApsaraStackDBReadWriteSplittingConnectionDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	rdsService := RdsService{client}
