...
func resourceApsaraStackEssScalingConfiguration() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackEssScalingConfigurationCreate,
		Read:   resourceApsaraStackEssScalingConfigurationRead,
		Update: resourceApsaraStackEssScalingConfigurationUpdate,
		Delete: resourceApsaraStackEssScalingConfigurationDelete,
...
func resourceApsaraStackEssScalingConfigurationCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackEssScalingConfigurationUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	...
	return resourceApsaraStackEssScalingConfigurationRead(d, meta)
}
...
func resourceApsaraStackEssScalingConfigurationDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	essService := EssService{client}
...
func buildApsaraStackEssScalingConfigurationArgs(d *schema.ResourceData, meta interface{}) (*ess.CreateScalingConfigurationRequest, error) {
	client := meta.(*connectivity.ApsaraStackClient)
...
func activeSubstituteScalingConfiguration(d *schema.ResourceData, meta interface{}) (configures []ess.ScalingConfiguration, err error) {
	...
	if err != nil {
		err = WrapErrorf(err, DefaultErrorMsg, d.Id(), request.GetActionName(), ApsaraStackSdkGoERROR)
		return
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
	response, _ := raw.(*ess.DescribeScalingConfigurationsResponse)
