...
func dataSourceApsaraStackKVStoreInstanceEngines() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackKVStoreInstanceEnginesRead,
...
func dataSourceApsaraStackKVStoreInstanceEnginesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_kvstore_instance_engines", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
