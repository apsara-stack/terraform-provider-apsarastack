...
func TestAccApsaraStackLogMachineGroup_basic(t *testing.T) {
	var v *sls.MachineGroup
	resourceId := "apsarastack_log_machine_group.default"
...
func TestAccApsaraStackLogMachineGroup_multi(t *testing.T) {
	var v *sls.MachineGroup
	resourceId := "apsarastack_log_machine_group.default.4"
	ra := resourceAttrInit(resourceId, logMachineGroupMap)
	serviceFunc := func() interface{} {
		return &LogService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
