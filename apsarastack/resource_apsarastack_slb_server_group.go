...
func resourceApsaraStackSlbServerGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackSlbServerGroupCreate,
		Read:   resourceApsaraStackSlbServerGroupRead,
		Update: resourceApsaraStackSlbServerGroupUpdate,
		Delete: resourceApsaraStackSlbServerGroupDelete,
...
func resourceApsaraStackSlbServerGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_slb_server_group", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func resourceApsaraStackSlbServerGroupRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackSlbServerGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	...
	return resourceApsaraStackSlbServerGroupRead(d, meta)
}

func resourceApsaraStackSlbServerGroupDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	slbService := SlbService{client}
