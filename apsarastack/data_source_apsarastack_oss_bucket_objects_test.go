...
func TestAccApsaraStackOssBucketObjectsDataSource_basic(t *testing.T) {
	rand := acctest.RandIntRange(1000000, 9999999)
	resourceId := "data.apsarastack_oss_bucket_objects.default"
	...
	bucketNameConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"bucket_name": "${apsarastack_oss_bucket_object.default.bucket}",
		}),
	}
	...
	keyRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"bucket_name": "${apsarastack_oss_bucket_object.default.bucket}",
			"key_regex":   "${apsarastack_oss_bucket_object.default.key}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"bucket_name": "${apsarastack_oss_bucket_object.default.bucket}",
			"key_regex":   "${apsarastack_oss_bucket_object.default.key}-fake",
		}),
	}
...
func TestAccApsaraStackOssBucketObjectsDataSource_versioning(t *testing.T) {
	rand := acctest.RandIntRange(1000000, 9999999)
	resourceId := "data.apsarastack_oss_bucket_objects.default"
...
resource "apsarastack_oss_bucket_object" "default" {
