...
func resourceApsaraStackEssLifecycleHook() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackEssLifeCycleHookCreate,
		Read:   resourceApsaraStackEssLifeCycleHookRead,
		Update: resourceApsaraStackEssLifeCycleHookUpdate,
		Delete: resourceApsaraStackEssLifeCycleHookDelete,
...
func resourceApsaraStackEssLifeCycleHookCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err := resource.Retry(5*time.Minute, func() *resource.RetryError {
		...
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_ess_lifecyclehook", request.GetActionName(), ApsaraStackSdkGoERROR)
	}

	return resourceApsaraStackEssLifeCycleHookRead(d, meta)
}

func resourceApsaraStackEssLifeCycleHookRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackEssLifeCycleHookUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackEssLifeCycleHookDelete(d *schema.ResourceData, meta interface{}) error {
