...
func dataSourceApsaraStackEssLifecycleHooks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEssLifecycleHooksRead,
...
func dataSourceApsaraStackEssLifecycleHooksRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ess_lifecycle_hooks", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
