...
func resourceApsaraStackKeyPairAttachment() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackKeyPairAttachmentCreate,
		Read:   resourceApsaraStackKeyPairAttachmentRead,
		Delete: resourceApsaraStackKeyPairAttachmentDelete,
...
func resourceApsaraStackKeyPairAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceApsaraStackKeyPairAttachmentRead(d, meta)
}

func resourceApsaraStackKeyPairAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	ecsService := EcsService{client}
...
func resourceApsaraStackKeyPairAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	ecsService := EcsService{client}
	keyName := strings.Split(d.Id(), ":")[0]
