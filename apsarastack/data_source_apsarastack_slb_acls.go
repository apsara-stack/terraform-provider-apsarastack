...
func dataSourceApsaraStackSlbAcls() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSlbAclsRead,
...
func dataSourceApsaraStackSlbAclsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_slb_acls", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func slbAclsDescriptionAttributes(d *schema.ResourceData, acls []slb.Acl, client *connectivity.ApsaraStackClient, meta interface{}) error {
