...
func init() {
	resource.AddTestSweepers("apsarastack_cr_ee_namespace", &resource.Sweeper{
		Name: "apsarastack_cr_ee_namespace",
...
func TestAccApsaraStackCrEENamespace_Basic(t *testing.T) {
	setTestaccCrEEInstanceId(t)
	var v *cr_ee.GetNamespaceResponse
	resourceId := "apsarastack_cr_ee_namespace.default"
...
func TestAccApsaraStackCrEENamespace_Multi(t *testing.T) {
	setTestaccCrEEInstanceId(t)
	var v *cr_ee.GetNamespaceResponse
	resourceId := "apsarastack_cr_ee_namespace.default.4"
	ra := resourceAttrInit(resourceId, nil)
	serviceFunc := func() interface{} {
		return &CrService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
