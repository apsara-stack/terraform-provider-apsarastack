...
func dataSourceApsaraStackKeyPairs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackKeyPairsRead,
...
func dataSourceApsaraStackKeyPairsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_key_pairs", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
