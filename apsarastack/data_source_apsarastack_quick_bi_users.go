...
func dataSourceApsaraStackQuickBiUsers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackQuickBiUsersRead,
...
func dataSourceApsaraStackQuickBiUsersRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_quick_bi_users", action, ApsaraStackSdkGoERROR)
		}
