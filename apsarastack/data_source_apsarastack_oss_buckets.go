...
func dataSourceApsaraStackOssBuckets() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackOssBucketsRead,
...
func dataSourceApsaraStackOssBucketsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			...
			return WrapErrorf(err, DefaultErrorMsg, "GetBucketInfo", ApsaraStackOssGoSdk)
		}
