...
func dataSourceApsarastackCmsAlarmContactGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsarastackCmsAlarmContactGroupsRead,
...
func dataSourceApsarastackCmsAlarmContactGroupsRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_cms_alarm_contact_groups", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
