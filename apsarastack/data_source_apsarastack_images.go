...
func dataSourceApsaraStackImages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackImagesRead,
...
func dataSourceApsaraStackImagesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_images", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
