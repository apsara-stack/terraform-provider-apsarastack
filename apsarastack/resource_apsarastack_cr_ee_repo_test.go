...
func TestAccApsaraStackCrEERepo_Basic(t *testing.T) {
	setTestaccCrEEInstanceId(t)
	var v *cr_ee.GetRepositoryResponse
	resourceId := "apsarastack_cr_ee_repo.default"
...
func TestAccApsaraStackCrEERepo_Multi(t *testing.T) {
	setTestaccCrEEInstanceId(t)
	var v *cr_ee.GetRepositoryResponse
	resourceId := "apsarastack_cr_ee_repo.default.4"
	ra := resourceAttrInit(resourceId, nil)
	serviceFunc := func() interface{} {
		return &CrService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
