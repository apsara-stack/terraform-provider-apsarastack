...
func dataSourceApsaraStackEssScalingRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEssScalingRulesRead,
...
func dataSourceApsaraStackEssScalingRulesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_ess_scalingrules", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
