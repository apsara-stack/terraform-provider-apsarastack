...
func dataSourceApsaraStackCrEENamespaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackCrEENamespacesRead,
...
func dataSourceApsaraStackCrEENamespacesRead(d *schema.ResourceData, meta interface{}) error {
