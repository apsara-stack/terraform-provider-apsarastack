...
func dataSourceApsaraStackRouterInterfaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackRouterInterfacesRead,
...
func dataSourceApsaraStackRouterInterfacesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_router_interfaces", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
