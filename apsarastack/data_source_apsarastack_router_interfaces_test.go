...
resource "apsarastack_router_interface_connection" "bar" {
  interface_id = "${apsarastack_router_interface.accepting.id}"
...
resource "apsarastack_router_interface_connection" "foo" {
  ...
  opposite_interface_id = "${apsarastack_router_interface.accepting.id}"
  depends_on = [
    "apsarastack_router_interface_connection.bar"
  ]
}
