...
func dataSourceApsaraStackSnatEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSnatEntriesRead,
...
func dataSourceApsaraStackSnatEntriesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err := invoker.Run(func() error {
			...
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_snat_entries", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
