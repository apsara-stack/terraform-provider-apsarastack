...
func dataSourceApsaraStackMaxcomputeClusterQutaos() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackMaxcomputeClusterQutaosRead,
...
func dataSourceApsaraStackMaxcomputeClusterQutaosRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		err = WrapErrorf(err, DefaultErrorMsg, cluster, action, ApsaraStackSdkGoERROR)
		return err
	}
