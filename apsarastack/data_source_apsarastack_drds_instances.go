...
func dataSourceApsaraStackDRDSInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackDRDSInstancesRead,
...
func dataSourceApsaraStackDRDSInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_drds_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
