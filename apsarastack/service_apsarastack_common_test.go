...
type resourceCheck struct {
	// IDRefreshName, like "apsarastack_instance.foo"
	resourceId string
...
func getResourceDescribeMethod(resourceId string) (string, error) {
	start := strings.Index(resourceId, "apsarastack_")
	if start < 0 {
		return "", WrapError(fmt.Errorf("the parameter \"name\" don't contain string \"apsarastack_\""))
	}
	start += len("apsarastack_")
...
type dataSourceAttr struct {
	// IDRefreshName, like "data.apsarastack_dns_records.record"
	resourceId string
...
resource "apsarastack_vswitch" "this" {
...
resource "apsarastack_vswitch" "default" {
  vpc_id            = "${apsarastack_vpc.default.id}"
  cidr_block        = "172.16.0.0/24"
  availability_zone = "${data.apsarastack_zones.default.zones.0.multi_zone_ids[0]}"
  name              = "${var.name}"
}
`
...
data "apsarastack_emr_main_versions" "default" {
}

data "apsarastack_emr_instance_types" "default" {
    destination_resource = "InstanceType"
    cluster_type = data.apsarastack_emr_main_versions.default.main_versions.0.cluster_types.0
    support_local_storage = false
    instance_charge_type = "PostPaid"
    support_node_type = ["MASTER", "CORE"]
}

data "apsarastack_emr_disk_types" "data_disk" {
	destination_resource = "DataDisk"
	cluster_type = data.apsarastack_emr_main_versions.default.main_versions.0.cluster_types.0
	instance_charge_type = "PostPaid"
	instance_type = data.apsarastack_emr_instance_types.default.types.0.id
	zone_id = data.apsarastack_emr_instance_types.default.types.0.zone_id
}

data "apsarastack_emr_disk_types" "system_disk" {
...
resource "apsarastack_vswitch" "default" {
  vpc_id = "${apsarastack_vpc.default.id}"
  cidr_block = "172.16.0.0/21"
  availability_zone = "${data.apsarastack_emr_instance_types.default.types.0.zone_id}"
  name = "${var.name}"
}
...
data "apsarastack_emr_instance_types" "gateway" {
    destination_resource = "InstanceType"
...
data "apsarastack_emr_disk_types" "gateway_data_disk" {
	destination_resource = "DataDisk"
	cluster_type = "GATEWAY"
	instance_charge_type = "PostPaid"
	instance_type = data.apsarastack_emr_instance_types.gateway.types.0.id
	zone_id = data.apsarastack_emr_instance_types.gateway.types.0.zone_id
}
...
data "apsarastack_emr_disk_types" "gateway_system_disk" {
	destination_resource = "SystemDisk"
	cluster_type = "GATEWAY"
	instance_charge_type = "PostPaid"
	instance_type = data.apsarastack_emr_instance_types.gateway.types.0.id
...
resource "apsarastack_emr_cluster" "default" {
    name = "${var.name}"

    emr_ver = data.apsarastack_emr_main_versions.default.main_versions.0.emr_version
    ...
    host_group {
        ...
        node_count = "2"
        instance_type = data.apsarastack_emr_instance_types.default.types.0.id
        disk_type = data.apsarastack_emr_disk_types.data_disk.types.0.value
        disk_capacity = data.apsarastack_emr_disk_types.data_disk.types.0.min > 160 ? data.apsarastack_emr_disk_types.data_disk.types.0.min : 160
        disk_count = "1"
        sys_disk_type = data.apsarastack_emr_disk_types.system_disk.types.0.value
		sys_disk_capacity = data.apsarastack_emr_disk_types.system_disk.types.0.min > 160 ? data.apsarastack_emr_disk_types.system_disk.types.0.min : 160
    }
    ...
    user_defined_emr_ecs_role = apsarastack_ram_role.default.name
    ssh_enable = true
...
data "apsarastack_emr_instance_types" "local_disk" {
    destination_resource = "InstanceType"
    cluster_type = data.apsarastack_emr_main_versions.default.main_versions.0.cluster_types.0
...
data "apsarastack_emr_instance_types" "cloud_disk" {
    destination_resource = "InstanceType"
    cluster_type = data.apsarastack_emr_main_versions.default.main_versions.0.cluster_types.0
    instance_charge_type = "PostPaid"
    support_node_type = ["MASTER"]
    zone_id = data.apsarastack_emr_instance_types.local_disk.types.0.zone_id
}
...
data "apsarastack_emr_disk_types" "data_disk" {
	...
	cluster_type = data.apsarastack_emr_main_versions.default.main_versions.0.cluster_types.0
	instance_charge_type = "PostPaid"
	instance_type = data.apsarastack_emr_instance_types.cloud_disk.types.0.id
	zone_id = data.apsarastack_emr_instance_types.cloud_disk.types.0.zone_id
}
...
resource "apsarastack_vswitch" "default" {
  vpc_id = "${apsarastack_vpc.default.id}"
  cidr_block = "172.16.0.0/21"
  availability_zone = "${data.apsarastack_emr_instance_types.cloud_disk.types.0.zone_id}"
  name = "${var.name}"
}
