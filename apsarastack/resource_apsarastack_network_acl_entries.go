...
func resourceApsaraStackNetworkAclEntries() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackNetworkAclEntriesCreate,
		Read:   resourceApsaraStackNetworkAclEntriesRead,
		Update: resourceApsaraStackNetworkAclEntriesUpdate,
		Delete: resourceApsaraStackNetworkAclEntriesDelete,
...
func resourceApsaraStackNetworkAclEntriesCreate(d *schema.ResourceData, meta interface{}) error {

	d.SetId(d.Get("network_acl_id").(string) + COLON_SEPARATED + resource.UniqueId())

	return resourceApsaraStackNetworkAclEntriesUpdate(d, meta)
}

func resourceApsaraStackNetworkAclEntriesRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackNetworkAclEntriesUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
	parts, err := ParseResourceId(d.Id(), 2)
	if err != nil {
...
func resourceApsaraStackNetworkAclEntriesDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	vpcService := VpcService{client}
	parts, err := ParseResourceId(d.Id(), 2)
	if err != nil {
