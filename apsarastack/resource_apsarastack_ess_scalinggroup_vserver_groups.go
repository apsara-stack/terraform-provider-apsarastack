...
func resourceApsaraStackEssScalingGroupVserverGroups() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackEssVserverGroupsCreate,
		Read:   resourceApsaraStackEssVserverGroupsRead,
		Update: resourceApsaraStackEssVserverGroupsUpdate,
		Delete: resourceApsaraStackEssVserverGroupsDelete,
...
func resourceApsaraStackEssVserverGroupsCreate(d *schema.ResourceData, meta interface{}) error {
	d.SetId(d.Get("scaling_group_id").(string))
	return resourceApsaraStackEssVserverGroupsUpdate(d, meta)
}

func resourceApsaraStackEssVserverGroupsRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackEssVserverGroupsUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	essService := EssService{client}
	object, err := essService.DescribeEssScalingGroup(d.Id())
	if err != nil {
	...
	d.SetPartial("vserver_groups")
	d.Partial(false)
	return resourceApsaraStackEssVserverGroupsRead(d, meta)
}

func resourceApsaraStackEssVserverGroupsDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func attachVserverGroups(d *schema.ResourceData, client *connectivity.ApsaraStackClient, attachMap map[string]string, force bool) error {
	if len(attachMap) > 0 {
...
func detachVserverGroups(d *schema.ResourceData, client *connectivity.ApsaraStackClient, detachMap map[string]string, force bool) error {
	if len(detachMap) > 0 {
