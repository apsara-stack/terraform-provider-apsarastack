...
func dataSourceApsaraStackSecurityGroupRules() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSecurityGroupRulesRead,
...
func dataSourceApsaraStackSecurityGroupRulesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "security_group_rules", req.GetActionName(), ApsaraStackSdkGoERROR)
	}
