...
func TestAccApsaraStackGpdbInstancesDataSource(t *testing.T) {
	...
	resourceId := "data.apsarastack_gpdb_instances.default"
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_gpdb_instance.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${apsarastack_gpdb_instance.default.id}_fake"},
		}),
	}

	nameRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"name_regex": "${apsarastack_gpdb_instance.default.description}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex": "${apsarastack_gpdb_instance.default.description}_fake",
		}),
	}
	...
	availabilityZoneConf := dataSourceTestAccConfig{
		...
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex":        "${apsarastack_gpdb_instance.default.description}",
			"availability_zone": "${data.apsarastack_zones.default.zones.0.id}F",
		}),
	}
	...
	vSwitchIdConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"name_regex": "${apsarastack_gpdb_instance.default.description}",
			"vswitch_id": "${apsarastack_gpdb_instance.default.vswitch_id}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"name_regex": "${apsarastack_gpdb_instance.default.description}",
			"vswitch_id": "unknow",
