...
func (s *RdsService) DescribeDBInstance(id string) (*rds.DBInstanceAttribute, error) {
	...
	request.QueryParams = map[string]string{"AccessKeySecret": s.client.SecretKey, "Product": "rds"}
...
func (s *RdsService) DescribeDBAccount(id string) (*rds.DBInstanceAccount, error) {
	...
	if err := invoker.Run(func() error {
		...
		if IsExpectedErrors(err, []string{"InvalidDBInstanceId.NotFound"}) {
			return ds, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return ds, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	err = resource.Retry(5*time.Minute, func() *resource.RetryError {
		...
		if err != nil {
			if IsExpectedErrors(err, []string{"InternalError", "OperationDenied.DBInstanceStatus"}) {
				return resource.RetryableError(WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR))
			}
			if NotFoundError(err) || IsExpectedErrors(err, []string{"InvalidDBName.NotFound"}) {
				return resource.NonRetryableError(WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR))
			}
			return resource.NonRetryableError(WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR))
		}
...
func (s *RdsService) DescribeDBSecurityIps(instanceId string) (ips []rds.DBInstanceIPArray, err error) {
	...
	if err != nil {
		return nil, WrapErrorf(err, DefaultErrorMsg, instanceId, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func (s *RdsService) DescribeMultiIZByRegion() (izs []string, err error) {
	...
	if err != nil {
		return nil, WrapErrorf(err, DefaultErrorMsg, "MultiIZByRegion", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func (s *RdsService) DescribeBackupPolicy(id string) (*rds.DescribeBackupPolicyResponse, error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidDBInstanceId.NotFound"}) {
			return policy, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
...
func (s *RdsService) DescribeDbInstanceMonitor(id string) (monitoringPeriod int, err error) {
	...
	if err != nil {
		return 0, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func (s *RdsService) DescribeSQLCollectorPolicy(id string) (collectorPolicy *rds.DescribeSQLCollectorPolicyResponse, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidDBInstanceId.NotFound"}) {
			return collectorPolicy, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return collectorPolicy, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
...
func (s *RdsService) DescribeSQLCollectorRetention(id string) (collectorRetention *rds.DescribeSQLCollectorRetentionResponse, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidDBInstanceId.NotFound"}) {
			return collectorRetention, WrapErrorf(err, NotFoundMsg, ApsaraStackSdkGoERROR)
		}
		return collectorRetention, WrapErrorf(err, DefaultErrorMsg, id, request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	addDebug(request.GetActionName(), raw, request.RpcRequest, request)
...
func (s *RdsService) describeTags(d *schema.ResourceData) (tags []Tag, err error) {
	...
	if err != nil {
		tmp := make([]Tag, 0)
		return tmp, WrapErrorf(err, DefaultErrorMsg, d.Id(), request.GetActionName(), ApsaraStackSdkGoERROR)
	}
