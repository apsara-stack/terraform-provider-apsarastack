...
func TestAccApsaraStackSlbServerGroupsDataSource_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckApsaraStackSlbServerGroupsDataSourceBasic,
				Check: resource.ComposeTestCheckFunc(

					testAccCheckApsaraStackDataSourceID("data.apsarastack_slb_server_groups.default"),
					resource.TestCheckResourceAttr("data.apsarastack_slb_server_groups.default", "load_balancer_id.#", "0"),
				),
...
const testAccCheckApsaraStackSlbServerGroupsDataSourceBasic = `
variable "name" {
