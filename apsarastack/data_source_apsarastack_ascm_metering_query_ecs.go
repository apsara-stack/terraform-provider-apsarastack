...
func dataSourceApsarastackAscmMeteringQueryEcs() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsarastackAscmMeteringQueryEcsRead,
...
func dataSourceApsarastackAscmMeteringQueryEcsRead(d *schema.ResourceData, meta interface{}) error {
