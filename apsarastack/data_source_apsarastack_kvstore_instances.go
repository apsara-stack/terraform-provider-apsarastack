...
func dataSourceApsaraStackKVStoreInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackKVStoreInstancesRead,
...
func dataSourceApsaraStackKVStoreInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, "apsarastack_kvstore_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
