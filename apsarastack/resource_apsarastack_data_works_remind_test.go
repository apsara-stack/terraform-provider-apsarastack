...
func TestAccApsaraStackDataWorksRemind_basic0(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_data_works_remind.default"
	ra := resourceAttrInit(resourceId, ApsaraStackDataWorksRemindMap0)
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, ApsaraStackDataWorksRemindBasicDependence0)
...
var ApsaraStackDataWorksRemindMap0 = map[string]string{}

func ApsaraStackDataWorksRemindBasicDependence0(name string) string {
	return fmt.Sprintf(` 
variable "name" {
  default = "%s"
}
