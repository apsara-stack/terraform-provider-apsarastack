...
func dataSourceApsaraStackNetworkInterfaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsarastackNetworkInterfacesRead,
...
func dataSourceApsarastackNetworkInterfacesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_network_interfaces", request.GetActionName(), ApsaraStackGoClientFailure)
		}
