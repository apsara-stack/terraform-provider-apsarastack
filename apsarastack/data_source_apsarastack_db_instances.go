...
func dataSourceApsaraStackDBInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackDBInstancesRead,
...
func dataSourceApsaraStackDBInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_db_instances", request.GetActionName(), ApsaraStackSdkGoERROR)
		}
