...
func resourceApsaraStackSlbListener() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackSlbListenerCreate,
		Read:   resourceApsaraStackSlbListenerRead,
		Update: resourceApsaraStackSlbListenerUpdate,
		Delete: resourceApsaraStackSlbListenerDelete,
...
func resourceApsaraStackSlbListenerCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_slb_listener", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_slb_listener", startLoadBalancerListenerRequest.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	if httpForward {
		return resourceApsaraStackSlbListenerRead(d, meta)
	}
	return resourceApsaraStackSlbListenerUpdate(d, meta)
}
...
func resourceApsaraStackSlbListenerUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackSlbListenerDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	slbService := SlbService{client}
