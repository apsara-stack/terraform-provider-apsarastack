...
func dataSourceApsaraStackEdasDeployGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEdasDeployGroupsRead,
...
func dataSourceApsaraStackEdasDeployGroupsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_edas_deploy_groups", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
