...
func dataSourceApsaraStackZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackZonesRead,
...
func dataSourceApsaraStackZonesRead(d *schema.ResourceData, meta interface{}) error {
