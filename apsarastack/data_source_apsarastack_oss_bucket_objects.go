...
func dataSourceApsaraStackOssBucketObjects() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackOssBucketObjectsRead,
...
func dataSourceApsaraStackOssBucketObjectsRead(d *schema.ResourceData, meta interface{}) error {
