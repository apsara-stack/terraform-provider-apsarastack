					...
					"referer_config": []map[string]interface{}{
						{
							"allow_empty": "false",
							"referers": []string{
								"http://www.apsarastack.com",
								"https://www.apsarastack.com",
							},
						},
					},
				}),
...
func TestAccApsaraStackOssBucketVersioning(t *testing.T) {
	var v oss.GetBucketInfoResult
...
func TestAccApsaraStackOssBucketCheckSseRule(t *testing.T) {
	var v oss.GetBucketInfoResult
