...
func dataSourceApsaraStackCrEERepos() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackCrEEReposRead,
...
func dataSourceApsaraStackCrEEReposRead(d *schema.ResourceData, meta interface{}) error {
