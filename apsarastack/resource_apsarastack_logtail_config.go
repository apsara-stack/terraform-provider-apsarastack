...
func resourceApsaraStackLogtailConfig() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackLogtailConfigCreate,
		Read:   resourceApsaraStackLogtailConfigRead,
		Update: resourceApsaraStackLogtailConfiglUpdate,
		Delete: resourceApsaraStackLogtailConfigDelete,
...
func resourceApsaraStackLogtailConfigCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_logtail_config", "CreateConfig", ApsaraStackLogGoSdkERROR)
	}
	if debugOn() {
	...
	return resourceApsaraStackLogtailConfigRead(d, meta)
}

func resourceApsaraStackLogtailConfigRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackLogtailConfiglUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if update {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, d.Id(), "UpdateConfig", ApsaraStackLogGoSdkERROR)
		}
		if debugOn() {
...
func resourceApsaraStackLogtailConfigDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	logService := LogService{client}
	parts, err := ParseResourceId(d.Id(), 3)
	if err != nil {
	...
	if err != nil {
		...
		return WrapErrorf(err, DefaultErrorMsg, d.Id(), "DeleteConfig", ApsaraStackLogGoSdkERROR)
	}
