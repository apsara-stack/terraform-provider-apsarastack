...
func dataSourceApsaraStackKmsCiphertext() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackKmsCiphertextRead,
...
func dataSourceApsaraStackKmsCiphertextRead(d *schema.ResourceData, meta interface{}) error {
