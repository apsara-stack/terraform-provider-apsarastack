...
func dataSourceApsaraStackMaxcomputeCus() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackMaxcomputeCusRead,
...
func dataSourceApsaraStackMaxcomputeCusRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		err = WrapErrorf(err, DefaultErrorMsg, filter_query, action, ApsaraStackSdkGoERROR)
		return err
	}
