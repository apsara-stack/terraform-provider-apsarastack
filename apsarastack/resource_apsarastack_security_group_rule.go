...
func resourceApsaraStackSecurityGroupRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackSecurityGroupRuleCreate,
		Read:   resourceApsaraStackSecurityGroupRuleRead,
		Update: resourceApsaraStackSecurityGroupRuleUpdate,
		Delete: resourceApsaraStackSecurityGroupRuleDelete,
...
func resourceApsaraStackSecurityGroupRuleCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackSecurityGroupRuleRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackSecurityGroupRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackSecurityGroupRuleDelete(d *schema.ResourceData, meta interface{}) error {
	policy := parseSecurityRuleId(d, meta, 6)
	strPriority := parseSecurityRuleId(d, meta, 7)
	var priority int
	if policy == "" || strPriority == "" {
...
func buildApsaraStackSGRuleRequest(d *schema.ResourceData, meta interface{}) (*requests.CommonRequest, error) {
	client := meta.(*connectivity.ApsaraStackClient)
	ecsService := EcsService{client}
