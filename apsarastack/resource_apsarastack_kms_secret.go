...
func resourceApsaraStackKmsSecret() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackKmsSecretCreate,
		Read:   resourceApsaraStackKmsSecretRead,
		Update: resourceApsaraStackKmsSecretUpdate,
		Delete: resourceApsaraStackKmsSecretDelete,
...
func resourceApsaraStackKmsSecretCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_kms_secret", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func resourceApsaraStackKmsSecretRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
...
func resourceApsaraStackKmsSecretUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	kmsService := KmsService{client}
	d.Partial(true)
