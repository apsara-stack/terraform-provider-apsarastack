...
func dataSourceApsaraStackSlbListeners() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackSlbListenersRead,
...
func dataSourceApsaraStackSlbListenersRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_slb_listeners", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
