...
func init() {
	resource.AddTestSweepers("apsarastack_slb_ca_certificate", &resource.Sweeper{
		Name: "apsarastack_slb_ca_certificate",
...
func TestAccApsaraStackSlbCACertificate_basic(t *testing.T) {
	var sc *slb.CACertificate
	resourceId := "apsarastack_slb_ca_certificate.default"
...
func TestAccApsaraStackSlbCACertificate_multi(t *testing.T) {
	var sc *slb.CACertificate
	resourceId := "apsarastack_slb_ca_certificate.default.9"
	ra := resourceAttrInit(resourceId, ca_certificateMap)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &sc, func() interface{} {
		return &SlbService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}, "DescribeSlbCACertificate")
