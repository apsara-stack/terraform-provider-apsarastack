...
func init() {
	resource.AddTestSweepers("apsarastack_dms_enterprise_user", &resource.Sweeper{
		Name: "apsarastack_dms_enterprise_user",
...
func testSweepDMSEnterpriseUsers(region string) error {
	...
	for {
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_dms_enterprise_users", action, ApsaraStackSdkGoERROR)
		}
...
func TestAccApsaraStackDMSEnterpriseUser_basic(t *testing.T) {
	var v map[string]interface{}
	resourceId := "apsarastack_dms_enterprise_user.default"
