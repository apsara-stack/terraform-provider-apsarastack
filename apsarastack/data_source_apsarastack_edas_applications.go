...
func dataSourceApsaraStackEdasApplications() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackEdasApplicationsRead,
...
func dataSourceApsaraStackEdasApplicationsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_edas_applications", request.GetActionName(), ApsaraStackSdkGoERROR)
	}
