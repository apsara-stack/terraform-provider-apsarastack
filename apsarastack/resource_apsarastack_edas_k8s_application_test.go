...
func init() {
	resource.AddTestSweepers("apsarastack_edas_k8s_application", &resource.Sweeper{
		Name: "apsarastack_edas_k8s_application",
...
func TestAccApsaraStackEdasK8sApplication_basic(t *testing.T) {
	var v *edas.Applcation
	resourceId := "apsarastack_edas_k8s_application.default"
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"cluster_id":       "${apsarastack_edas_k8s_cluster.default.id}",
					"package_type":     "Image",
					"image_url":        image,
					"replicas":         "2",
...
/*
func TestAccApsaraStackEdasK8sApplicationJar_basic(t *testing.T) {
	var v *edas.Applcation
	resourceId := "apsarastack_edas_k8s_application.default"
	ra := resourceAttrInit(resourceId, edasK8sApplicationBasicMap)
	serviceFunc := func() interface{} {
...
func TestAccApsaraStackEdasK8sApplication_multi(t *testing.T) {
	var v *edas.Applcation
	resourceId := "apsarastack_edas_k8s_application.default.1"
	ra := resourceAttrInit(resourceId, edasK8sApplicationBasicMap)
	serviceFunc := func() interface{} {
		return &EdasService{testAccProvider.Meta().(*connectivity.ApsaraStackClient)}
	}
