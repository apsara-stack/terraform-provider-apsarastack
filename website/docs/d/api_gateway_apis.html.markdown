...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_api_gateway_apis"
sidebar_current: "docs-apsarastack-datasource-api-gateway-apis"
description: |-
    Provides a list of apis to the user.
---

# apsarastack\_api\_gateway\_apis
...
```
data "apsarastack_api_gateway_apis" "data_apigatway_apis" {
  output_file = "output_ApiGatawayApis"
}

output "first_api_id" {
  value = "${data.apsarastack_api_gateway_apis.data_apigatway.apis.0.id}"
}
```
