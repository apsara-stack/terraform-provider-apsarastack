...
subcategory: "ROS"
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_ros_templates"
sidebar_current: "docs-apsarastack-datasource-ros-templates"
description: |-
  Provides a list of Ros Templates to the user.
---

# apsarastack\_ros\_templates

This data source provides the Ros Templates of the current Apsara Stack Cloud user.
...
```terraform
data "apsarastack_ros_templates" "example" {
  ids        = ["example_value"]
  name_regex = "the_resource_name"
}

output "first_ros_template_id" {
  value = data.apsarastack_ros_templates.example.templates.0.id
}
```
