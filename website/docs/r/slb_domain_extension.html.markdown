...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_slb_domain_extension"
sidebar_current: "docs-apsarastack-resource-slb-domain-extension"
description: |-
  Provides a Load Banlancer domain extension Resource and add it to one Listener.
---

# apsarastack\_slb\_domain_extension
...
resource "apsarastack_slb_domain_extension" "example1" {
  load_balancer_id      = "${apsarastack_slb.instance.id}"
