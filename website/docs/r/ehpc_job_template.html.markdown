...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_ehpc_job_template"
sidebar_current: "docs-apsarastack-resource-ehpc-job-template"
description: |-
  Provides a Apsarastack Ehpc Job Template resource.
---

# apsarastack\_ehpc\_job\_template
...
```
$ terraform import apsarastack_ehpc_job_template.example <id>
```
