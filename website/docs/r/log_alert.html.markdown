...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_log_alert"
sidebar_current: "docs-apsarastack-resource-log-alert"
description: |-
  Provides a Apsarastack log alert resource.
---

# apsarastack\_log\_alert
...
resource "apsarastack_log_alert" "example" {
  project_name      = apsarastack_log_project.example.name
...
```
$ terraform import apsarastack_log_alert.example tf-log:tf-log-alert
```
