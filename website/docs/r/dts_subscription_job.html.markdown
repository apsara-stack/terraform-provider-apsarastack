...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_dts_subscription_job"
sidebar_current: "docs-apsarastack-resource-dts-subscription-job"
description: |-
  Provides a Apsarastack DTS Subscription Job resource.
---

# apsarastack\_dts\_subscription\_job
...
data "apsarastack_vpcs" "default1" {
  name_regex = "default-NODELETING"
}

data "apsarastack_vswitches" "default_1" {
  vpc_id = data.apsarastack_vpcs.default.ids[0]
}

resource "apsarastack_dts_subscription_job" "default" {
  dts_job_name                       = var.name
  payment_type                       = "PostPaid"
  source_endpoint_engine_name        = "MySQL"
  source_endpoint_region             = "cn-hangzhou"
  source_endpoint_instance_type      = "RDS"
  source_endpoint_instance_id        = apsarastack_db_instance.instance.id
  ...
  subscription_instance_vpc_id       = data.apsarastack_vpcs.default1.ids[0]
  subscription_instance_vswitch_id   = data.apsarastack_vswitches.default_1.ids[0]
  status                             = "Normal"
}
```
...
```
$ terraform import apsarastack_dts_subscription_job.example <id>
```
