...
If you want to add public IP, you can use resource 'apsarastack_eip_association' to bind several elastic IPs for one Nat Gateway.
...
```
$ terraform import apsarastack_nat_gateway.example ngw-abc123456
```
