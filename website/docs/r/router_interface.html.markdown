...
-> **NOTE:** The router interface is not connected when it is created. It can be connected by means of resource [apsarastack_router_interface_connection](https://www.terraform.io/docs/providers/apsarastack/r/router_interface_connection.html).
...
* `opposite_router_type` - (Deprecated) It has been deprecated from version 1.11.0. resource apsarastack_router_interface_connection's 'opposite_router_type' instead.
* `router_id` - (Required, ForceNew) The Router ID.
* `opposite_router_id` - (Deprecated) It has been deprecated from version 1.11.0. Use resource apsarastack_router_interface_connection's 'opposite_router_id' instead.
...
* `opposite_interface_id` - (Deprecated) It has been deprecated from version 1.11.0. Use resource apsarastack_router_interface_connection's 'opposite_router_id' instead.
* `opposite_interface_owner_id` - (Deprecated) It has been deprecated from version 1.11.0. Use resource apsarastack_router_interface_connection's 'opposite_interface_id' instead.
...
```
$ terraform import apsarastack_router_interface.interface ri-abc123456
```
