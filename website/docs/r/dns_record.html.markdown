...
resource "apsarastack_dns_record" "record" {
  name        = "domainname"
  host_record = "@"
  type        = "A"
  value       = "192.168.99.99"
...
```
$ terraform import apsarastack_dns_record.example abc123456
```
