...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_dts_synchronization_job"
sidebar_current: "docs-apsarastack-resource-dts-synchronization-job"
description: |-
  Provides a Apsarastack DTS Synchronization Job resource.
---

# apsarastack\_dts\_synchronization\_job
...
resource "apsarastack_dts_synchronization_job" "default" {
  dts_instance_id                    = apsarastack_dts_synchronization_instance.default.id
...
* `dts_instance_id` - (Required, ForceNew) Synchronizing instance ID. The ID of `apsarastack_dts_synchronization_instance`.
* `synchronization_direction` - (Optional, ForceNew) Synchronization direction. Valid values: `Forward`, `Reverse`. Only when the property `sync_architecture` of the `apsarastack_dts_synchronization_instance` was `bidirectional` this parameter should be passed, otherwise this parameter should not be specified.
...
```
$ terraform import apsarastack_dts_synchronization_job.example <id>
```
